...
describe('pendência', () => {
    ...
    it('teste Associação-consultar', () => {
        ...
        cy.get('#form_filtro_geral > :nth-child(2) > :nth-child(1) > .form-group > label').should('have.text', "Tipo")
        cy.get('#form_filtro_geral > :nth-child(2) > :nth-child(2) > .form-group > label').should('have.text', "Natureza")
        cy.get('#form_filtro_geral > :nth-child(2) > :nth-child(3) > .form-group > label').should('have.text', "Objeto")
        ...
        cy.get(':nth-child(4) > :nth-child(1) > .form-group > label').should('have.text', "Área da Poligonal de Estudo")
        cy.get(':nth-child(4) > :nth-child(2) > :nth-child(1) > label').should('have.text', "Status")
        cy.get(':nth-child(4) > :nth-child(3) > .form-group > .control-label').should('have.text', "Órgão Externo Avaliador	")
        ...
        cy.get(':nth-child(3) > .box-header > .box-title').should('have.text', "Dados da Ordem de Serviço")
        ...
        cy.get("[onclick=\"toggleFormAccordion('os')\"] > b").should('have.text', "Dados da Ordem de Serviço")
        ...
        cy.get('[onclick="window.history.back()"]').click()
        cy.get('[onclick="window.history.back()"]').click()
        cy.get('.form-group > .select2-container > .selection > .select2-selection > .select2-selection__rendered > .select2-selection__clear').click()
        cy.get('.select2-results').find('li').contains('NELSON ALVES LOUZEIRO JUNIOR').click({force: true})
        cy.get(':nth-child(2) > .form-group > .select2-container > .selection > .select2-selection > .select2-selection__rendered > .select2-selection__clear').click()
        cy.get('.select2-results').find('li').contains('PEDRO RAFAEL MANDAI').click({force: true})
        cy.get('#pesquisar').click()


        //validando o botão de excluir
        cy.get('#excluir_87 > .fas').click()
